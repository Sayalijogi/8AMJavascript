...
//objName.propertyName="value" ==>add =>CURD
obj1.language="hindi" //add
obj1.firstName="Vaibhav" //update
console.log(obj1)
console.log(obj.lastName) //retrive
delete obj1.firstName //delete
console.log(obj1)